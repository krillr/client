...
var substituteTests = []substituteTest{
	...
	{a: "^%{dns_proof_hostname}/(?:.well-known/keybase.txt|keybase.txt)$", b: "^example\\.com/(?:.well-known/keybase.txt|keybase.txt)$"},
...
var sampleVars = PvlScriptVariables{
	...
	SigIDShort:       "000",
	DNSProofHostname: "example.com",
}

func TestSubstitute(t *testing.T) {
	for _, test := range substituteTests {
		res := substitute(test.a, sampleVars)
		if res != test.b {
